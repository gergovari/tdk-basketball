...
def main():
    ...
    parser.add_argument("--pose-model", default="yolov8x-pose-p6.engine", help="YOLO-Pose model filename (in model_dir)")
    ...
    parser.add_argument('--follow-through', type=float, default=0.5, help="Seconds to record after the release (default: 0.5)")
